...
Rationale: Next.js allows us to use Server Components for fast SEO-optimized page loads of JOCA history and events, while leveraging Server Actions for secure, type-safe member registration and election voting.

In addition, Next.js was a good framework in terms of achieving a balance between learning and developing using what we as a team were familiar with. 
